...
<head>
	...
	<style>
		div#content>div#content2>div#right>div.fy{
			text-align: right;
		}
		div#content>div#content2>div#right>div.fy>input{
			border: 1px solid #D1D3D8;
			border-radius: 3px;width: 28px;height: 28px;
			margin: 8px;
		}
		div#content>div#content2>div#right>div.fy>button{
			border: 1px solid #D1D3D8;
			border-radius: 3px;width: 63px;height: 28px;margin-right: 20px;
		}
	</style>
	...
	<div id="container">
		...
		<div id="navigation">
			<ul>
				...
				<li class="active"><a href="index7.php">下载专区</a></li>
			</ul>
		</div>
		<div id="content">
			<div id="content2">
				<ul>
					<li class="li1"><img src="img/5_03.png" width="16px" height="16px" alt="">培训资料</li>
					<li class="li2"><img src="img/5_03.png" width="16px" height="16px" alt="">软件工具</li>
					<li class="li3"><img src="img/6_03.png" width="16px" height="16px" alt="">其他资料</li>
				</ul>
				<div id="right" style="display: block;">
					...
					<div class="fy">
						<input type="button" value="1"><input type="button" value="2"><input type="button" value="3"><span>...</span><input type="button" value="10">
