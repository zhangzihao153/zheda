	...
	<div id="container">
		...
		<div id="navigation">
			<ul>
				...
				<li class="active"><a href="index6.php">知识库</a></li>
		...
		<div id="content">
			<div id="content2">
				<ul>
					<li class="li1"><img src="img/5_03.png" width="16px" height="16px" alt="">分析指引</li>
					<li class="li2"><img src="img/5_03.png" width="16px" height="16px" alt="">税证辑要</li>
					<li class="li3"><img src="img/6_03.png" width="16px" height="16px" alt="">案例库</li>
				</ul>
