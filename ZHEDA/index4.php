	...
	<div id="container">
		...
		<div id="navigation">
			<ul>
				...
				<li class="active"><a href="index4.php">工作动态</a></li>
		...
		<div id="content">
			<div id="content2">
				<ul>
					<li class="li1"><img src="img/5_03.png" width="16px" height="16px" alt="">通知公告</li>
					<li class="li2"><img src="img/5_03.png" width="16px" height="16px" alt="">省局动态</li>
					<li class="li3"><img src="img/6_03.png" width="16px" height="16px" alt="">市县动态</li>
					<li class="li3"><img src="img/6_03.png" width="16px" height="16px" alt="">党建动态</li>
				</ul>
