	...
	<div id="container">
		...
		<div class="context">
			<div class="left">
				...
				<div class="leftone">
					<p>通知公告<a href="#">更多...</a></p>
					<ul>
						<li><a href="#">滨江区、西湖区、余杭区税务局顺利完成社保费首个征期工作</a></li>
						<li><a href="#">西湖区税务局顺畅发票通道 助力优化区域营商环境</a></li>
						<li><a href="#">富阳区税务局联合多部门实现企业开办当日结</a></li>
						<li><a href="#">财政部、税务总局联合发文进一步明确永续债的企业所得税税收信息发布..</a></li>
						<li><a href="#">西城区税务、市场监管部门联合推出“e窗通企业一日准营套餐服务</a></li>
					</ul>
				</div>
				<div class="leftone">
					<p>省局动态<a href="#">更多...</a></p>
					<ul>
						<li><a href="#">财政部、税务总局联合发文进一步明确永续债的企业所得税税收信息发布..</a></li>
						<li><a href="#">西城区税务、市场监管部门联合推出“e窗通企业一日准营套餐服务</a></li>
				...
				<div class="lefttow">
					<p>党建动态<a href="#">更多...</a></p>
					<ul>
						<img src="img/2_11.png" width="200px" height="184px">
						<li><a href="#">财政部、税务总局联合发文进一步明..</a></li>
						<li><a href="#">西城区税务、市场监管部门联合推出…</a></li>
						<li><a href="#">税法入童心 税收伴成长</a></li>
						<li><a href="#">下沙区税务局个体工商户个税管理成效</a></li>
						<li><a href="#">萧山区税务局开展“减税降费 纳税人…</a></li>
						<li><a href="#">萧山区税务局开展“减税降费 纳税人…</a></li>
					</ul>
				</div>
			</div>
			<div class="right">
				<div class="rightimg">
					<p>大企业区域分布图</p>
					<img src="img/3.png" height="559px" width="560px">
				</div>
				<div class="leftone">
					<p>市县动态<a href="#">更多...</a></p>
					<ul>
